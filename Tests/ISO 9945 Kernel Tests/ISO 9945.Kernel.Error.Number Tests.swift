...
extension Error_Primitives.Error.Number.Test.Unit {
    ...
    func `noEntry equals ENOENT`() {
        #expect(
            Error_Primitives.Error.Number.noEntry
                == Error_Primitives.Error.Number(_unchecked: ENOENT)
        )
    }
    ...
    func `accessDenied equals EACCES`() {
        #expect(
            Error_Primitives.Error.Number.accessDenied
                == Error_Primitives.Error.Number(_unchecked: EACCES)
        )
    }
    ...
    func `notPermitted equals EPERM`() {
        #expect(
            Error_Primitives.Error.Number.notPermitted
                == Error_Primitives.Error.Number(_unchecked: EPERM)
        )
    }
    ...
    func `exists equals EEXIST`() {
        #expect(
            Error_Primitives.Error.Number.exists
                == Error_Primitives.Error.Number(_unchecked: EEXIST)
        )
    }
    ...
    func `isDirectory equals EISDIR`() {
        #expect(
            Error_Primitives.Error.Number.isDirectory
                == Error_Primitives.Error.Number(_unchecked: EISDIR)
        )
    }
    ...
    func `processLimit equals EMFILE`() {
        #expect(
            Error_Primitives.Error.Number.processLimit
                == Error_Primitives.Error.Number(_unchecked: EMFILE)
        )
    }
    ...
    func `systemLimit equals ENFILE`() {
        #expect(
            Error_Primitives.Error.Number.systemLimit
                == Error_Primitives.Error.Number(_unchecked: ENFILE)
        )
    }
    ...
    func `invalid equals EINVAL`() {
        #expect(
            Error_Primitives.Error.Number.invalid
                == Error_Primitives.Error.Number(_unchecked: EINVAL)
        )
    }
    ...
    func `interrupted equals EINTR`() {
        #expect(
            Error_Primitives.Error.Number.interrupted
                == Error_Primitives.Error.Number(_unchecked: EINTR)
        )
    }
    ...
    func `wouldBlock equals EAGAIN`() {
        #expect(
            Error_Primitives.Error.Number.wouldBlock
                == Error_Primitives.Error.Number(_unchecked: EAGAIN)
        )
    }
    ...
    func `noDevice equals ENODEV`() {
        #expect(
            Error_Primitives.Error.Number.noDevice
                == Error_Primitives.Error.Number(_unchecked: ENODEV)
        )
    }
    ...
    func `notDirectory equals ENOTDIR`() {
        #expect(
            Error_Primitives.Error.Number.notDirectory
                == Error_Primitives.Error.Number(_unchecked: ENOTDIR)
        )
    }
    ...
    func `readOnlyFilesystem equals EROFS`() {
        #expect(
            Error_Primitives.Error.Number.readOnlyFilesystem
                == Error_Primitives.Error.Number(_unchecked: EROFS)
        )
    }
    ...
    func `noSpace equals ENOSPC`() {
        #expect(
            Error_Primitives.Error.Number.noSpace
                == Error_Primitives.Error.Number(_unchecked: ENOSPC)
        )
    }
    ...
    func `badDescriptor equals EBADF`() {
        #expect(
            Error_Primitives.Error.Number.badDescriptor
                == Error_Primitives.Error.Number(_unchecked: EBADF)
        )
    }
}
