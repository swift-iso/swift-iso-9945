...
extension ISO_9945.Kernel.File.Open.Options.Test.Unit {
    ...
    func `Options from rawValue`() {
        let options = ISO_9945.Kernel.File.Open.Options(rawValue: 1)
...
extension ISO_9945.Kernel.File.Open.Options.Test.Unit {
    ...
    func `create maps to O_CREAT`() {
        #expect(ISO_9945.Kernel.File.Open.Options.create.rawValue == O_CREAT)
    }

    @Test
    func `truncate maps to O_TRUNC`() {
        #expect(ISO_9945.Kernel.File.Open.Options.truncate.rawValue == O_TRUNC)
    }

    @Test
    func `append maps to O_APPEND`() {
        #expect(ISO_9945.Kernel.File.Open.Options.append.rawValue == O_APPEND)
    }

    @Test
    func `exclusive maps to O_EXCL`() {
        #expect(ISO_9945.Kernel.File.Open.Options.exclusive.rawValue == O_EXCL)
    }
...
extension ISO_9945.Kernel.File.Open.Options.Test.Unit {
    ...
    @Test
    func `contains check`() {
        let options: ISO_9945.Kernel.File.Open.Options = [.create, .exclusive]
        #expect(options.contains(.create))
    ...
    func `union of options`() {
        let a: ISO_9945.Kernel.File.Open.Options = [.create]
        let b: ISO_9945.Kernel.File.Open.Options = [.truncate]
    ...
    func `intersection of options`() {
        let a: ISO_9945.Kernel.File.Open.Options = [.create, .truncate]
        let b: ISO_9945.Kernel.File.Open.Options = [.truncate, .append]
...
extension ISO_9945.Kernel.File.Open.Options.Test.Unit {
    ...
    func `create rawValue contains O_CREAT`() {
        let options: ISO_9945.Kernel.File.Open.Options = [.create]
        #expect(options.rawValue & O_CREAT != 0)
    }

    @Test
    func `truncate rawValue contains O_TRUNC`() {
        let options: ISO_9945.Kernel.File.Open.Options = [.truncate]
        #expect(options.rawValue & O_TRUNC != 0)
    }

    @Test
    func `append rawValue contains O_APPEND`() {
        let options: ISO_9945.Kernel.File.Open.Options = [.append]
    ...
    func `noFollow rawValue contains O_NOFOLLOW`() {
        let options: ISO_9945.Kernel.File.Open.Options = [.noFollow]
        #expect(options.rawValue & O_NOFOLLOW != 0)
    }

    @Test
    func `combined options rawValue maps correctly`() {
        let options: ISO_9945.Kernel.File.Open.Options = [.create, .truncate, .exclusive]
...
extension ISO_9945.Kernel.File.Open.Options.Test.Unit {
    ...
    func `Options is Equatable`() {
        let a: ISO_9945.Kernel.File.Open.Options = [.create]
        let b: ISO_9945.Kernel.File.Open.Options = [.create]
        let c: ISO_9945.Kernel.File.Open.Options = [.truncate]
        #expect(a == b)
        #expect(a != c)
    }
