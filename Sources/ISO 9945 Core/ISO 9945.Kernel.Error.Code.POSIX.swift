...
extension Kernel.Error.Code.POSIX {
    ...
    @inlinable
    public static var EPERM: Kernel.Error.Code { .posix(1) }

    /// Permission denied (errno 13).
    ///
    /// File/directory access control denied the operation.
    @inlinable
    public static var EACCES: Kernel.Error.Code { .posix(13) }

    /// Read-only file system (errno 30).
    @inlinable
    public static var EROFS: Kernel.Error.Code { .posix(30) }

    // MARK: Path Resolution Errors

    /// No such file or directory (errno 2).
    @inlinable
    public static var ENOENT: Kernel.Error.Code { .posix(2) }

    /// File exists (errno 17).
    @inlinable
    public static var EEXIST: Kernel.Error.Code { .posix(17) }

    /// Cross-device link (errno 18).
    @inlinable
    public static var EXDEV: Kernel.Error.Code { .posix(18) }

    /// Not a directory (errno 20).
    @inlinable
    public static var ENOTDIR: Kernel.Error.Code { .posix(20) }

    /// Is a directory (errno 21).
    @inlinable
    public static var EISDIR: Kernel.Error.Code { .posix(21) }

    // MARK: Descriptor Errors

    /// Bad file descriptor (errno 9).
    @inlinable
    public static var EBADF: Kernel.Error.Code { .posix(9) }

    // MARK: I/O Errors

    /// I/O error (errno 5).
    @inlinable
    public static var EIO: Kernel.Error.Code { .posix(5) }

    /// Device not configured (errno 6).
    @inlinable
    public static var ENXIO: Kernel.Error.Code { .posix(6) }

    /// No such device (errno 19).
    @inlinable
    public static var ENODEV: Kernel.Error.Code { .posix(19) }

    /// Invalid argument (errno 22).
    @inlinable
    public static var EINVAL: Kernel.Error.Code { .posix(22) }

    /// Illegal seek (errno 29).
    @inlinable
    public static var ESPIPE: Kernel.Error.Code { .posix(29) }

    /// Broken pipe (errno 32).
    @inlinable
    public static var EPIPE: Kernel.Error.Code { .posix(32) }

    // MARK: Resource Errors

    /// Cannot allocate memory (errno 12).
    @inlinable
    public static var ENOMEM: Kernel.Error.Code { .posix(12) }

    /// Bad address (errno 14).
    @inlinable
    public static var EFAULT: Kernel.Error.Code { .posix(14) }

    /// Too many open files in system (errno 23).
    @inlinable
    public static var ENFILE: Kernel.Error.Code { .posix(23) }

    /// Too many open files (errno 24).
    @inlinable
    public static var EMFILE: Kernel.Error.Code { .posix(24) }

    /// No space left on device (errno 28).
    @inlinable
    public static var ENOSPC: Kernel.Error.Code { .posix(28) }

    // MARK: Interrupt and Blocking

    /// Interrupted system call (errno 4).
    @inlinable
    public static var EINTR: Kernel.Error.Code { .posix(4) }
}
...
extension Kernel.Error.Code.POSIX {
    ...
    @inlinable
    public static var EAGAIN: Kernel.Error.Code { .posix(35) }

    /// Operation would block (Darwin errno 35).
    ///
    /// On Darwin, EAGAIN and EWOULDBLOCK have the same value (35).
    @inlinable
    public static var EWOULDBLOCK: Kernel.Error.Code { .posix(35) }

    /// Too many levels of symbolic links (Darwin errno 62).
    @inlinable
    public static var ELOOP: Kernel.Error.Code { .posix(62) }

    /// File name too long (Darwin errno 63).
    @inlinable
    public static var ENAMETOOLONG: Kernel.Error.Code { .posix(63) }

    /// Directory not empty (Darwin errno 66).
    @inlinable
    public static var ENOTEMPTY: Kernel.Error.Code { .posix(66) }

    /// Disc quota exceeded (Darwin errno 69).
    @inlinable
    public static var EDQUOT: Kernel.Error.Code { .posix(69) }

    /// Connection reset by peer (Darwin errno 54).
    @inlinable
    public static var ECONNRESET: Kernel.Error.Code { .posix(54) }

    /// Operation not supported (Darwin errno 45).
    @inlinable
    public static var ENOTSUP: Kernel.Error.Code { .posix(45) }

    /// Deadlock detected (Darwin errno 11).
    @inlinable
    public static var EDEADLK: Kernel.Error.Code { .posix(11) }

    /// No locks available (Darwin errno 77).
    @inlinable
    public static var ENOLCK: Kernel.Error.Code { .posix(77) }
}
#endif
...
extension Kernel.Error.Code.POSIX {
    ...
    @inlinable
    public static var EAGAIN: Kernel.Error.Code { .posix(11) }

    /// Operation would block (Linux errno 11).
    ///
    /// On Linux, EAGAIN and EWOULDBLOCK have the same value (11).
    @inlinable
    public static var EWOULDBLOCK: Kernel.Error.Code { .posix(11) }

    /// File name too long (Linux errno 36).
    @inlinable
    public static var ENAMETOOLONG: Kernel.Error.Code { .posix(36) }

    /// Directory not empty (Linux errno 39).
    @inlinable
    public static var ENOTEMPTY: Kernel.Error.Code { .posix(39) }

    /// Too many levels of symbolic links (Linux errno 40).
    @inlinable
    public static var ELOOP: Kernel.Error.Code { .posix(40) }

    /// Disc quota exceeded (Linux errno 122).
    @inlinable
    public static var EDQUOT: Kernel.Error.Code { .posix(122) }

    /// Connection reset by peer (Linux errno 104).
    @inlinable
    public static var ECONNRESET: Kernel.Error.Code { .posix(104) }

    /// Operation not supported (Linux errno 95).
    @inlinable
    public static var ENOTSUP: Kernel.Error.Code { .posix(95) }

    /// Deadlock detected (Linux errno 35).
    @inlinable
    public static var EDEADLK: Kernel.Error.Code { .posix(35) }

    /// No locks available (Linux errno 37).
    @inlinable
    public static var ENOLCK: Kernel.Error.Code { .posix(37) }
}
#endif
...
extension Kernel.Error.Code.POSIX {
    ...
    @inlinable
    public static var ENOTSUP: Kernel.Error.Code { .posix(91) }
...
extension Kernel.Error.Code.POSIX {
    ...
    @inlinable
    public static func isELOOP(_ code: Kernel.Error.Code) -> Bool {
        switch code {
    ...
    /// Use this for cross-platform matching when the value differs by platform.
    @inlinable
    public static func isENOTEMPTY(_ code: Kernel.Error.Code) -> Bool {
        switch code {
    ...
    /// Use this for cross-platform matching when the value differs by platform.
    @inlinable
    public static func isENAMETOOLONG(_ code: Kernel.Error.Code) -> Bool {
        switch code {
    ...
    /// Use this for cross-platform matching when the value differs by platform.
    @inlinable
    public static func isEAGAIN(_ code: Kernel.Error.Code) -> Bool {
        switch code {
    ...
    /// Use this for cross-platform matching when the value differs by platform.
    @inlinable
    public static func isEDQUOT(_ code: Kernel.Error.Code) -> Bool {
        switch code {
    ...
    /// Use this for cross-platform matching when the value differs by platform.
    @inlinable
    public static func isECONNRESET(_ code: Kernel.Error.Code) -> Bool {
        switch code {
    ...
    /// Use this for cross-platform matching when the value differs by platform.
    @inlinable
    public static func isENOTSUP(_ code: Kernel.Error.Code) -> Bool {
        switch code {
